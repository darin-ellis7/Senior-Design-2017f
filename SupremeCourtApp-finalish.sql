...
--
-- Host: localhost
-- Generation Time: Nov 10, 2017 at 03:59 AM
...
(281, 'Allentown'),
(282, 'Lehigh River'),
(283, 'Lehigh County Courthouse'),
(284, 'U.S. County'),
(285, 'United States district court'),
(286, 'United States District Court for the Eastern District of Pennsylvania'),
(287, 'The Express-Times'),
...
(356, 'Apple Fifth Avenue'),
(357, 'iOS'),
(358, 'Apple TV'),
(359, 'Samsung Galaxy S6'),
(360, 'Bob Menendez'),
(361, 'New Jersey'),
...
(367, 'Summer'),
(368, 'Cabin'),
(369, 'Chestnut Hill College'),
(370, 'Hill College'),
(371, 'Chestnut Hill'),
(372, 'College'),
(373, 'NYC Party Bus Pros'),
(374, 'College Avenue'),
(375, 'Language'),
(376, 'English language'),
(377, 'Izglītība Ārzemēs'),
(378, 'Michigan'),
(379, 'Casino'),
(380, 'Nation'),
(381, 'DC USA'),
...
--
ALTER TABLE `article`
  MODIFY `idArticle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=326;

--
-- AUTO_INCREMENT for table `article_keywords`
--
ALTER TABLE `article_keywords`
  MODIFY `idKey` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2289;

--
-- AUTO_INCREMENT for table `entity_instances`
--
ALTER TABLE `entity_instances`
  MODIFY `idInstance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=861;

--
-- AUTO_INCREMENT for table `image`
--
ALTER TABLE `image`
  MODIFY `idImage` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=283;

--
-- AUTO_INCREMENT for table `image_entities`
--
ALTER TABLE `image_entities`
  MODIFY `idEntity` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=454;

--
-- AUTO_INCREMENT for table `keyword_instances`
--
ALTER TABLE `keyword_instances`
  MODIFY `idInstance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4779;
